                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">                           <!-- member login form-->
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form  action="codePhp.php" method="post">     <!-- php use to connect with db-->
                                        <div class="form-group">
                                            
                                            <label><br>Check your email. We sent you an email with five digit confirmation code. Enter it below to continue to reset your password</label>
                                            <input class="form-control" name="code" id= "code" placeholder = "#####">                                            
                                        </div>
