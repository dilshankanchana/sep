	...
	<div id="menu-wrapper">
		<div id="menu" class="container">
			<ul>                                                               <!-- top selection tab-->  
				...
				<li class = "current_page_item"><a href="Login.php">Appointments</a></li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">                           <!-- member login form-->
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form  action="LoginPhp.php" method="post">     <!-- php use to connect with db-->
                                        <div class="form-group">
                                            
                                            <label><br>Email</label>
                                            <input class="form-control" name="email" id= "emailId" input type = "email" required>
                                            <label><br>Password</label>
                                            <input type="password" class="form-control" name="password" id="pwd" onChange="showUser(this.value)" required><label>
                                        </div>
                                             
                                        
                                        <input type="submit" class="btn btn-default" value = "Continue">
                                            <button  class="btn btn-default"><a href="Register.php"> Register </a></button>
                                        <button  class="btn btn-default" style="display: none;"><a href="Register.php"> Register </a></button>
										
                                    </form>
									
									<p id="word"> <a href="forgot.php"  >Forgot your password?</a></p>
